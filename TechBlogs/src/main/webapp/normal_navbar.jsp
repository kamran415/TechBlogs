<nav class="navbar navbar-expand-lg navbar-dark primary-background my-1">
	<a class="navbar-brand" href="index.jsp"><span class="fa fa-asterisk">TechBlogs</span></a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="Login.jsp"><span class="fa fa-user-o "></span> Login</a></li>
			<li class="nav-item"><a class="nav-link" href="Register.jsp"><span class="fa fa-user-plus "></span> Signup</a></li>		
		</ul>
